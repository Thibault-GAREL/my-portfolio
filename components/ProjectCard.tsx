  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between gap-1 md:gap-2 mb-1">
        ...
        <p className="text-gray-600 dark:text-[#768390] text-sm mb-2">{description}</p>
