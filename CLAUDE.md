...
- Scission de **Generative AI** en deux catégories (2026-09-18), dans cet ordre après Research paper : **📝 Language Models** (`#6e40c9`, l'ancien violet : Original LLM, RAG PDF ChatBot, CLIP Embedding Tools, Modern LLM) puis **🖼️ Vision Models** (`#c026d3`, fuchsia : GAN, LoRA Stable Diffusion, World Models). Même découpage dans le README GitHub. CLIP a d'abord été rangé dans Vision Models, puis déplacé dans Language Models à la demande de Thibault.
...
- **Cas limite à connaître** : "Robot Controlled by Local LLM" (22 juil. au 11 oct. 2025) a son milieu au 31 août, soit un jour avant la bascule, donc il est classé en 3rd year. Pour le faire basculer, il faut corriger ses dates réelles, pas ajouter une exception.
...
- 🖼️ Vision Models : `#ef4444` (rouge des skills schema-svg et thibault-remotion, ex fuchsia)
